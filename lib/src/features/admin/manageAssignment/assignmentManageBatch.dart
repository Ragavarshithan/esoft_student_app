...
//
// class AssignmentManagebatchScreen extends ConsumerStatefulWidget {
//   final String courseId;
//   final String moduleId;
//   final String moduleName;
//   const AssignmentManagebatchScreen({super.key, required this.courseId, required this.moduleId, required this.moduleName});
//
//   @override
//   ConsumerState<AssignmentManagebatchScreen> createState() => _AssignmentManagebatchScreen();
// }
//
// class _AssignmentManagebatchScreen extends ConsumerState<AssignmentManagebatchScreen> {
//   @override
...
//                 trailing: TextButton(
//                     onPressed: ()=> Navigator.push(context, MaterialPageRoute(builder: (context) => ManageAssignmentScreen(moduleId: widget.moduleId, moduleName: widget.moduleName,))),
//                     child: const Text('View Assignments', style: TextStyle(color: Color(0xFF1E3A8A))),
//                 ),
//               ),
//             ),
//             onTap: () {
//               Navigator.push(context, MaterialPageRoute(builder: (context) =>  ManageAssignmentScreen( moduleId: widget.moduleId, moduleName: widget.moduleName,)));
//             },
//           );
//         },
//       ),
