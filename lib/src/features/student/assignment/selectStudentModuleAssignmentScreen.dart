...
class SelectStudentModuleAssignmentsScreen extends ConsumerStatefulWidget {
  final String batchId;
  final String courseId;
  final String courseName;
  const SelectStudentModuleAssignmentsScreen({super.key, required this.courseId, required this.courseName, required this.batchId});

  @override
  ConsumerState<SelectStudentModuleAssignmentsScreen> createState() => _SelectStudentModuleAssignmentsScreen();
}

class _SelectStudentModuleAssignmentsScreen extends ConsumerState<SelectStudentModuleAssignmentsScreen> {
  @override
