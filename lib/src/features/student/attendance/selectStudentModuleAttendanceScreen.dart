...
class SelectStudentModuleAttendanceScreen extends ConsumerStatefulWidget {
  final String batchId;
  final String courseId;
  final String courseName;
  const SelectStudentModuleAttendanceScreen({super.key, required this.courseId, required this.courseName, required this.batchId});

  @override
  ConsumerState<SelectStudentModuleAttendanceScreen> createState() => _SelectStudentModuleAttendanceScreen();
}

class _SelectStudentModuleAttendanceScreen extends ConsumerState<SelectStudentModuleAttendanceScreen> {
  @override
