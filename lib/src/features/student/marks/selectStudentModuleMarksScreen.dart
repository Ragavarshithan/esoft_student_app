...
class SelectStudentModuleMarksScreen extends ConsumerStatefulWidget {
  final String batchId;
  final String courseId;
  final String courseName;
  const SelectStudentModuleMarksScreen({super.key, required this.courseId, required this.courseName, required this.batchId});

  @override
  ConsumerState<SelectStudentModuleMarksScreen> createState() => _SelectStudentModuleMarksScreen();
}

class _SelectStudentModuleMarksScreen extends ConsumerState<SelectStudentModuleMarksScreen> {
  @override
