...
class SelectLectureStudentBatchScreen extends ConsumerStatefulWidget {
  const SelectLectureStudentBatchScreen({super.key});

  @override
  ConsumerState<SelectLectureStudentBatchScreen> createState() => _SelectLectureStudentBatchScreen();
}

class _SelectLectureStudentBatchScreen extends ConsumerState<SelectLectureStudentBatchScreen> {
  @override
