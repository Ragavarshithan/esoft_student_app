...
class ViewMyStudentScreen extends StatefulWidget {
  final String studentName;
  final String studentEmail;
  final String course;
  final String batch;
  const ViewMyStudentScreen({super.key,required this.course, required this.batch, required this.studentName, required this.studentEmail});

  @override
  State<ViewMyStudentScreen> createState() => _ViewMyStudentScreenState();
}

class _ViewMyStudentScreenState extends State<ViewMyStudentScreen>
