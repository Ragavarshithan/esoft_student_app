...
class SelectLecturerCourseScreen extends ConsumerStatefulWidget {
  const SelectLecturerCourseScreen({super.key});

  @override
  ConsumerState<SelectLecturerCourseScreen> createState() => _SelectLecturerCourseScreen();
}

class _SelectLecturerCourseScreen extends ConsumerState<SelectLecturerCourseScreen> {
  @override
