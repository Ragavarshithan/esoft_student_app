...
class MyModuleScreen extends ConsumerStatefulWidget {
  final String batchId;
  final String courseId;
  final String courseName;
  const MyModuleScreen({super.key, required this.courseId, required this.courseName, required this.batchId});

  @override
  ConsumerState<MyModuleScreen> createState() => _MyModuleScreen();
}

class _MyModuleScreen extends ConsumerState<MyModuleScreen> {
  @override
