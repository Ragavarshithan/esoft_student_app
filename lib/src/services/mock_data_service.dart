...
class MockDataService {
  final List<AppUser> users = [
    ...
    // Students (15)
    const Student(id: 's1', name: 'John Doe', email: 'john.doe@student.esoft.lk', batchId: 'b1', enrolledCourseIds: ['c1', 'c2', 'c3'], studentId: '', batchName: ''),
    const Student(id: 's2', name: 'Jane Smith', email: 'jane.smith@student.esoft.lk', batchId: 'b1', enrolledCourseIds: ['c1', 'c2'], studentId: '', batchName: ''),
    const Student(id: 's3', name: 'Michael Chen', email: 'michael.chen@student.esoft.lk', batchId: 'b1', enrolledCourseIds: ['c1', 'c3', 'c4'], studentId: '', batchName: ''),
    const Student(id: 's4', name: 'Emma Wilson', email: 'emma.wilson@student.esoft.lk', batchId: 'b2', enrolledCourseIds: ['c2', 'c3'], studentId: '', batchName: ''),
    const Student(id: 's5', name: 'David Brown', email: 'david.brown@student.esoft.lk', batchId: 'b2', enrolledCourseIds: ['c1', 'c4', 'c5'], studentId: '', batchName: ''),
    const Student(id: 's6', name: 'Lisa Anderson', email: 'lisa.anderson@student.esoft.lk', batchId: 'b1', enrolledCourseIds: ['c2', 'c4'], studentId: '', batchName: ''),
    const Student(id: 's7', name: 'Robert Taylor', email: 'robert.taylor@student.esoft.lk', batchId: 'b2', enrolledCourseIds: ['c1', 'c2', 'c3'], studentId: '', batchName: ''),
    const Student(id: 's8', name: 'Sophie Martinez', email: 'sophie.martinez@student.esoft.lk', batchId: 'b1', enrolledCourseIds: ['c3', 'c4', 'c5'], studentId: '', batchName: ''),
    const Student(id: 's9', name: 'James Garcia', email: 'james.garcia@student.esoft.lk', batchId: 'b3', enrolledCourseIds: ['c1', 'c5'], studentId: '', batchName: ''),
    const Student(id: 's10', name: 'Olivia Lee', email: 'olivia.lee@student.esoft.lk', batchId: 'b2', enrolledCourseIds: ['c2', 'c3', 'c4'], studentId: '', batchName: ''),
    const Student(id: 's11', name: 'William Rodriguez', email: 'william.rodriguez@student.esoft.lk', batchId: 'b1', enrolledCourseIds: ['c1', 'c2'], studentId: '', batchName: ''),
    const Student(id: 's12', name: 'Isabella White', email: 'isabella.white@student.esoft.lk', batchId: 'b3', enrolledCourseIds: ['c3', 'c5'], studentId: '', batchName: ''),
    const Student(id: 's13', name: 'Lucas Johnson', email: 'lucas.johnson@student.esoft.lk', batchId: 'b2', enrolledCourseIds: ['c4', 'c5'], studentId: '', batchName: ''),
    const Student(id: 's14', name: 'Mia Thompson', email: 'mia.thompson@student.esoft.lk', batchId: 'b1', enrolledCourseIds: ['c1', 'c3'], studentId: '', batchName: ''),
    const Student(id: 's15', name: 'Noah Jackson', email: 'noah.jackson@student.esoft.lk', batchId: 'b3', enrolledCourseIds: ['c2', 'c4', 'c5'], studentId: '', batchName: ''),

    // Lecturers (8)
    const Lecturer(id: 'l1', name: 'Dr. Smith', email: 'smith@lecturer.esoft.lk', assignedCourseIds: ['c1', 'c2'], lecturerId: ''),
    const Lecturer(id: 'l2', name: 'Prof. Emily Davis', email: 'emily.davis@lecturer.esoft.lk', assignedCourseIds: ['c3', 'c4'], lecturerId: ''),
    const Lecturer(id: 'l3', name: 'Dr. James Wilson', email: 'james.wilson@lecturer.esoft.lk', assignedCourseIds: ['c5'], lecturerId: ''),
    const Lecturer(id: 'l4', name: 'Prof. Michelle Brown', email: 'michelle.brown@lecturer.esoft.lk', assignedCourseIds: ['c1', 'c3'], lecturerId: ''),
    const Lecturer(id: 'l5', name: 'Dr. Robert Chen', email: 'robert.chen@lecturer.esoft.lk', assignedCourseIds: ['c2', 'c4'], lecturerId: ''),
    const Lecturer(id: 'l6', name: 'Prof. Lisa Anderson', email: 'lisa.anderson@lecturer.esoft.lk', assignedCourseIds: ['c1', 'c5'], lecturerId: ''),
    const Lecturer(id: 'l7', name: 'Dr. Mark Johnson', email: 'mark.johnson@lecturer.esoft.lk', assignedCourseIds: ['c3'], lecturerId: ''),
    const Lecturer(id: 'l8', name: 'Prof. Sarah Martinez', email: 'sarah.martinez@lecturer.esoft.lk', assignedCourseIds: ['c4', 'c5'], lecturerId: ''),
  ];
